...
//    }
//
//    public ArrayList<HistoryItem> getAllPlayers() {
...
//                @SuppressLint("Range") String func = cursor.getString(cursor.getColumnIndex(COLUMN_FUNC));@SuppressLint("Range") DateFormat date = cursor.getClass(cursor.getColumnIndex(COLUMN_DATE));
//
